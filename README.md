...
## Como funciona
- Você escolhe um mês (1 a 12).
- Escolhe em qual dia da semana o mês começa (0 a 6).
- O programa calcula quantos dias o mês tem.
- Ele imprime a sequência com as letras dos dias para colar no Excel.
...
Como era um script simples, eu rodava **direto na web**, usando compiladores online como:
...
Basta colar o código, clicar em **Run** e usar no navegador mesmo — sem instalar nada no PC.
